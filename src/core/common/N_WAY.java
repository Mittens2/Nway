...
public interface N_WAY {
	...
	public static final int RANDOM_SEARCH = 16;
	
	
	public static MathContext MATH_CTX = new MathContext(7, RoundingMode.HALF_EVEN);
	
	public static final int ALL_ALGOS = PAIR_WISE | GREEDY | BEST_LOCAL_SEARCH | FIRST_LOCAL_SEARCH | RANDOM_SEARCH;
	...
	public enum ALG_POLICY{
		REPLACE_FIRST, REPLACE_BEST, GREEDY, PAIR_WISE,REPLACE_FIRST_BY_SQUARES, REPLACE_BEST_BY_SQUARES, RANDOM
	}
