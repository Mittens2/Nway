		...
		File file = new File(filePath);
		 ...
		 try {
			 ...
			 while(true){
				 ...
				 if(modelLine == null)
					 break;
				 int firstIndexOfComma = modelLine.indexOf(",");
				 int lastIndexOfComma = modelLine.lastIndexOf(",");
				 String tmpModelId = modelLine.substring(0,firstIndexOfComma);
				 String lbl = modelLine.substring(firstIndexOfComma+1,lastIndexOfComma);
				 String props = modelLine.substring(lastIndexOfComma+1);
				...
				//	 continue;
				 ...
				 Element e = new Element(lbl, props, currModelId);
				 e.setAsRaw();
				 mdl.addElement(e);
